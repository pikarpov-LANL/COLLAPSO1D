...
!               end if                                                  
     ...
     &              dumynue(imax),dumynueb(imax),dumynux(imax)          
         write(*,*)'dynue,dynueb,dynux',                                &
     &              f2ynue(imax),f2ynueb(imax),f2ynux(imax)             
         write(*,*)'unue,unueb,unux',                                   &
     &              dumunue(imax),dumunueb(imax),dumunux(imax)          
         write(*,*)'dunue,dunueb,dunux',                                &
     &              f2unue(imax),f2unueb(imax),f2unux(imax)             
!                                                                       
