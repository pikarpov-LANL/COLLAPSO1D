...
c********************************************************************
c                                                                   *
c  This program reads the unformatted file and pritns readable      *
c  numbers.                                                         *
c                                                                   *
c********************************************************************
c
...
c            write(72,103) t,vmin,xshock,rho(1),rhomax
 ...
 104           format('.',I4.4)
            ...
            do i=1,nc
c               write(69,103)i,encm(i),x(i),rho(i),v(i),ye(i),
c     $           vsound(i)
c
ceta(i),
c     $              temp(i),u2(i),u(i),ynue(i),ynueb(i),ynux(i)
...
c                  if (i.gt.700) then
c                     if (i.eq.701) write(69,*) t*10.
c                  if (encm(i).gt.1.512.and.encm(i).lt.11.0) then
...
c                       write(69,105) encm(i),1.d9*x(i),
c     $                       2.d6*rho(i),
c     $                       1.d16*u(i),
c$                       1.d16*(u(i)+860.),
c     $                    1.d16*pr(i),1.d8*v(i),1.d9*temp(i),ye(i),
c     $                      5.165268d8*dsqrt(encm(i)/x(i))
                     else
                       dene2=dene2+
     $                       deltam(i)*(1.d16*u(i)-
     $                       1.d14*ufreez(i)+v(i)**2-vg**2)
c                        write(69,105) encm(i),1.d9*x(i),
c     $                       2.d6*rho(i),1.d16*u(i),
c     $                       1.d16*pr(i),1.d8*v(i),1.d9*temp(i)
c1.d14*ufreez(i),1.d16*pr(i),1.d8*v(i)
                     end if
