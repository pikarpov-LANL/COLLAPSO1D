c-- BHR 2.0 module to run in parallel along the code.

c-- Input: 1D grid form each timestep
c--         - spherical symmetry is applied upon it         
c--           to get compute BHR corrections in 3D
c-- Output: BHR corrections to transport equations,
c--         integrated over theta and phi to collapse
c--         to 1D
